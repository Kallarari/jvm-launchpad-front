    ...
    <S.Container>
      ...
      <S.Content>
        ...
        <AccordionItem title="Qual é o nível ideal de participantes?">
             ...
             Sêniores ou superiores são convidados a participar como Mentores ou em funções voluntárias similares.
        </AccordionItem>
        ...
        <AccordionItem title="Como funciona a Fila de Espera?">
             <span>Devido à natureza voluntária e à organização em Squads fixas,
               infelizmente não é possível atender a toda a demanda de participação de uma só vez.</span>
        ...
        <AccordionItem title="Como Funciona a Gamificação?">
             O projeto é dividido em Etapas (Níveis) que funcionam como mini-projetos de dificuldade progressiva, começando do mais fácil e avançando gradualmente.
        ...
        <AccordionItem title="Pontuação e Recompensas">
             -Quem recebe pontos?
             <li>Todos os participantes recebem pontos, tanto individuais quanto como uma Squad.</li>
             -Como ganhar pontos? 
             <li>A Squad ganha pontos ao terminar corretamente uma etapa/mini-projeto.</li>
        </AccordionItem>

        <AccordionItem title="Formação das Equipes">
             -O que é uma Squad?
             <li>A unidade básica do projeto. É composta por três participantes, sendo um deles designado como Líder.</li>
             -Como são formadas? 
             <li>As Squads são formadas pela administração do projeto, agrupando os participantes. O cadastro inicial é via formulário (atualmente Google Forms).</li>
             -As Squads são permanentes?
             <li>Não. A composição é flexível e pode mudar conforme as regras de negócio e necessidades do projeto.</li>
             -Pode haver substituição ou transferência?
             <li>Se um membro for desativado, ele será substituído para manter a Squad com três membros. O projeto permite a transferência de participantes entre Squads conforme necessidade.</li>
        </AccordionItem>

        <AccordionItem title="Papel do Líder da Squad">
             -O que é Líder da Squad?
             <li>O Líder é a figura central da Squad, responsável tanto pela gestão técnica quanto pelo desenvolvimento dos membros.</li>
             -Quais são as responsabilidades de um Líder da Squad?
        ...
        <AccordionItem title="Troca de Liderança (Meritocracia)">
             ...
             <li>Um Líder pode perder o cargo (sendo rebaixado a Membro ou saindo do projeto) se seu desempenho ou atitude exigirem.</li>
             -Promoção do Membro: 
             <li>- Um Membro pode ser promovido a novo Líder da Squad se destacar-se e demonstrar maior aptidão ou comprometimento que o Líder atual.</li>
        </AccordionItem>
