...
export const SquadsDevPageContext = createContext<SquadsRankingProps | undefined>(undefined)

export const useSquadsDevPageContext = () => {
  const context = useContext(SquadsDevPageContext);
  if (context === undefined) {
    throw new Error('useSquadsDevPageContext must be used within an SquadsDevPageProvider');
  }
  return context;
}
